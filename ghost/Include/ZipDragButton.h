// ZipDragButton.h: interface for the CZipDragButton class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _GHOSTZipDragButton_
#define _GHOSTZipDragButton_
...
class __declspec(dllexport) CZipDragButton  
{
public:
	
	// tworzy na podstawie systemu pliku
	
	CZipDragButton(char cFileSystem[], char cPassword[], char clicked_name[], 
	...
	virtual void		Cut(int iMaxX, int iMaxY);

private:
	
	IDirect3DDevice8	*m_pDevice;
	
	char		m_cPassword[256]; // do zapamietania
	...
	CZipSprite		*m_pOnDragButton;		// mysz nad nim
	...
	CZipSprite		*m_pOnMove;		// przesuwany myszka
	...
	CZipSprite		*m_pDropped;	// upuszczony przycisk moze np. miec wiekszy rozmiar
...
#endif // !defined(AFX_ZipDragButton_H__5E00FEAF_DE67_4436_9881_6636BBF0EC75__INCLUDED_)
