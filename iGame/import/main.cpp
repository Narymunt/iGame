...
main (int argc, char **argv)
{
	...
	screen = FOX_SetVideoMode(800, 600, 16,
			(FOX_SWSURFACE|FOX_ASYNCBLIT|FOX_DOUBLEBUF));
...
//	smokul->Put(screen,100,100,    ulTimer%72);
	...
	smokul->Put(screen,
		smokul->fevZdarzenia[0]->iXKlatki[h4], 
		smokul->fevZdarzenia[0]->iYKlatki[h4],
		smokul->fevZdarzenia[0]->uiNrKlatki[h4]); 

	h3 = jasio->fevZdarzenia[0]->ulLiczbaKlatek;
	
	jasio->Put(screen,
		jasio->fevZdarzenia[0]->iXKlatki[h4], 
		jasio->fevZdarzenia[0]->iYKlatki[h4],
		jasio->fevZdarzenia[0]->uiNrKlatki[h4]); 
