...
void CScene001::SetActive(bool bState)
{
	m_bActive = bState;
}
...
bool CScene001::bGetActive(void)
{
	return m_bActive;
}
...
void CScene001::Initialize(IDirect3DDevice8 *pDevice)
{
	
	m_pFile = new CFileSystem("demo.bin");	// otworz archiwum
	m_pFile->Load("back002.jpg");	// wczytujemy tlo
...
void CScene001::DeInitialize(void)
{
...
int CScene001::DrawScene(IDirect3DDevice8 *pDevice, long lTimer)
{
